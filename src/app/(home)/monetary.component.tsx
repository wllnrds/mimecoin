...
export default function MonetaryWidget() {
    ...
    return <div className="flex flex-col gap-10 w-full">
        ...
        <div className={`shadow-2xl border-1 border-neutral-100 p-10 rounded-[2rem] w-full transition-transform rotate-x-[5deg] ${ index == 1 ? '-rotate-y-[30deg]' : 'rotate-y-[30deg]' }`}>
