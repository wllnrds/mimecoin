...
export default async function Home() {
	return (
		<div className="bg-primary">
			<div className="bg-white rounded-t-[40px] mt-4 flex flex-col">
				<HeaderMenu />
				<div className="p-2 md:p-5 flex flex-col gap-10">
					...
					<section className="m-2 md:m-5 flex gap-3 flex-col lg:flex-row relative rounded-[40px] bg-center justify-center" style={{ minHeight: 'max(calc(85vh - 10rem), 380px)' }}>
					...
					<section className="m-2 md:m-5 flex gap-3 flex-col lg:flex-row relative rounded-[40px] bg-center bg-gradient-to-tr from-primary-600 via-primary to-primary-400" style={{ minHeight: 'max(calc(85vh - 10rem), 380px)' }}>
						<div className="flex-1 p-10 md:p-20 flex flex-col gap-4 items-start justify-center">
							...
							<ButtonLink auth="all" href="/" style="bg-white hover:bg-slate-200">criar seu mime</ButtonLink>
						</div>
						<div className="flex-1 p-10 md:p-20 flex flex-col gap-4 justify-center">
							<div className="bg-white rounded-2xl py-3 px-4 flex flex-row gap-3 items-center transition-all hover:shadow-small hover:-translate-y-1 ">
								<span className="w-8 h-8 flex items-center justify-center text-2xl text-primary"><span className="material-icon">check</span></span>
								conta digital
							</div>
							<div className="bg-white rounded-2xl py-3 px-4 flex flex-row gap-3 items-center transition-all hover:shadow-small hover:-translate-y-1 ">
								<span className="w-8 h-8 flex items-center justify-center text-2xl text-primary"><span className="material-icon">check</span></span>
							...
							<span className="text-xs">*Todas as transações usam o token da conta em que foi gerada e não representam valores monetários reais</span>
						</div>
					</section>

					<section className="m-2 md:m-5 flex-col flex gap-10 relative rounded-[40px] bg-center justify-center" style={{ minHeight: 'max(calc(85vh - 10rem), 380px)' }}>
						<div className="text-center">
							<div className="text-5xl sm:text-6xl leading-[1.1]"><span className="drop-shadow-md">Preços</span> <span className="text-primary"></span></div>
						</div>
						<div className=" relative w-full flex flex-col md:flex-row gap-10 justify-center items-center">
							<div className="min-w-[240px] max-w-[280px] bg-white w-full overflow-clip flex flex-col gap-4">
								<div className="px-3 py-3 bg-primary text-center font-black uppercase rounded-[40px]">grátis</div>
								<div className="p-3 text-xs">
									<ul className="p-3">
										<li className="py-2"><strong>Sistemas</strong> 1 por conta</li>
										<li className="py-2"><strong>Modos</strong> <span>pontos</span> | <span>monetário</span></li>
										<li className="py-2"><strong>Precisão decimal</strong> <span>0</span> ou <span>2</span></li>
										<li className="py-2"><strong>Limite</strong> 10000 unidades*</li>
										<li className="py-2"><strong>Máximo de contas</strong> 89.999 contas</li>
									</ul>
									<div className="md:h-10"></div>
								</div>
								<ButtonLink auth="all" href="/" style="bg-primary items-center justify-center hover:bg-primary-500">criar seu mime</ButtonLink>
							...
							<div className="min-w-[240px] max-w-[280px] border-1 bg-white rounded-[40px] w-full overflow-clip flex flex-col">
								<div className="p-6 flex flex-col text-xs flex-1 items-center justify-center gap-4 md:gap-10">
									...
									<ButtonLink auth="all" target="_blank" href="mailto:w.almeida.w@gmail.com" style="bg-primary hover:bg-slate-200">Entre em contato</ButtonLink>
								</div>
							</div>
						</div>
					</section>
