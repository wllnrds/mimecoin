    ...
    <div className="bg-white rounded-t-[40px] mt-4 flex flex-col gap-10">
      ...
      <div className="px-4 md:px-10 flex flex-col gap-10">
        <header className="relative flex gap-3 flex-col">
          <div className="flex gap-3 flex-col relative rounded-[40px] bg-cover bg-center" style={{ backgroundImage: 'url(/assets/home/cover.png)', minHeight: 'max(calc(90vh - 10rem), 480px)' }} ></div>
