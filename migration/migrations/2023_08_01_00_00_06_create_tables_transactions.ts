...
export async function up(db: Kysely<any>): Promise<void> {
	await db.schema
		...
		.addColumn('namespaceAccount', 'varchar', (col) => col.references('NamespaceAccount.accountNumber'))
		.addColumn('namespaceAccountOrigin', 'varchar', (col) => col.references('NamespaceAccount.accountNumber'))
		.addColumn('namespaceAccountTarget', 'varchar', (col) => col.references('NamespaceAccount.accountNumber'))
